...
public class FurnaceRecipes
{
    ...
    private FurnaceRecipes()
    {
        ...
        /**-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
        this.addSmelting(Block.oreCuivre.blockID, new ItemStack(Item.cuivre), 1.0F);
        this.addSmelting(Block.oreCitrine.blockID, new ItemStack(Item.citrine), 1.0F);
        this.addSmelting(Block.oreEmeraude.blockID, new ItemStack(Item.emeraude), 1.0F);
        this.addSmelting(Block.oreSaphir.blockID, new ItemStack(Item.saphir), 1.0F);
        this.addSmelting(Block.oreRubis.blockID, new ItemStack(Item.rubis), 1.0F);
        this.addSmelting(Block.glowStone.blockID, new ItemStack(Block.lanterne2), 0.7F);
        this.addSmelting(Block.lanterne2.blockID, new ItemStack(Block.lanterne1), 0.7F);
        /**-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
