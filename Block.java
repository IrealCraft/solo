...
public class Block
{
    ...
    public static final Block[] blocksList = new Block[8192];

    /**
     * An array of 8192 booleans corresponding to the result of the isOpaqueCube() method for each block ID
     */
    public static final boolean[] opaqueCubeLookup = new boolean[8192];

    /** How much light is subtracted for going through this block */
    public static final int[] lightOpacity = new int[8192];

    /** Array of booleans that tells if a block can grass */
    public static final boolean[] canBlockGrass = new boolean[8192];

    /** Amount of light emitted */
    public static final int[] lightValue = new int[8192];

    /**
     * Flag if block ID should use the brightest neighbor light value as its own
     */
    public static boolean[] useNeighborBrightness = new boolean[8192];
    ...
    /**-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
    public static final Block blockCuivre = (new BlockOreStorage(500)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setUnlocalizedName("blockCuivre");
    public static final Block blockCitrine = (new BlockOreStorage(501)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setUnlocalizedName("blockCitrine");
    public static final Block blockSaphir = (new BlockOreStorage(502)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setUnlocalizedName("blockSaphir");
    public static final Block blockRubis = (new BlockOreStorage(503)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setUnlocalizedName("blockRubis");
    public static final Block blockEmeraude = (new BlockOreStorage(504)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setUnlocalizedName("blockEmeraude");
    public static final Block oreCuivre = (new BlockOre(505)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("oreCuivre");
    public static final Block oreCitrine = (new BlockOre(506)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("oreCitrine");
    public static final Block oreEmeraude = (new BlockOre(507)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("oreEmeraude");
    public static final Block oreSaphir = (new BlockOre(508)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("oreSaphir");
    public static final Block oreRubis = (new BlockOre(509)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("oreRubis");
    public static final Block blockVerreColored = (new BlockVerreColored(510)).setUnlocalizedName("blockVerreColored").setStepSound(soundGlassFootstep).setHardness(0.7F);
    public static final Block tapisLaine = (new BlockTapisLaine(511)).setUnlocalizedName("tapisLaine").setStepSound(soundClothFootstep).setHardness(0.7F);
    public static final Block tapisVerre = (new BlockTapisVerre(512)).setUnlocalizedName("tapisVerre").setStepSound(soundGlassFootstep).setHardness(0.7F);
    
    public static final Block stairsVerreWhite = (new BlockStairs(513, blockVerreColored, 0)).setUnlocalizedName("stairsVerreWhite");
    public static final Block stairsVerreOrange = (new BlockStairs(514, blockVerreColored, 1)).setUnlocalizedName("stairsVerreOrange");
    public static final Block stairsVerreMagenta = (new BlockStairs(515, blockVerreColored, 2)).setUnlocalizedName("stairsVerreMagenta");
    public static final Block stairsVerreSkyBlue = (new BlockStairs(516, blockVerreColored, 3)).setUnlocalizedName("stairsVerreSkyBlue");
    public static final Block stairsVerreYellow = (new BlockStairs(517, blockVerreColored, 4)).setUnlocalizedName("stairsVerreYellow");
    public static final Block stairsVerreGreen = (new BlockStairs(518, blockVerreColored, 5)).setUnlocalizedName("stairsVerreGreen");
    public static final Block stairsVerrePink = (new BlockStairs(519, blockVerreColored, 6)).setUnlocalizedName("stairsVerrePink");
    public static final Block stairsVerreDarkGrey = (new BlockStairs(520, blockVerreColored, 7)).setUnlocalizedName("stairsVerreDarkGrey");
    public static final Block stairsVerreLightGrey = (new BlockStairs(521, blockVerreColored, 8)).setUnlocalizedName("stairsVerreLightGrey");
    public static final Block stairsVerreCyan = (new BlockStairs(522, blockVerreColored, 9)).setUnlocalizedName("stairsVerreCyan");
    public static final Block stairsVerrePurple = (new BlockStairs(523, blockVerreColored, 10)).setUnlocalizedName("stairsVerrePurple");
    public static final Block stairsVerreDarkBlue = (new BlockStairs(524, blockVerreColored, 11)).setUnlocalizedName("stairsVerreDarkBlue");
    public static final Block stairsVerreBrown = (new BlockStairs(525, blockVerreColored, 12)).setUnlocalizedName("stairsVerreBrown");
    public static final Block stairsVerreDarkGreen = (new BlockStairs(526, blockVerreColored, 13)).setUnlocalizedName("stairsVerreDarkGreen");
    public static final Block stairsVerreRed = (new BlockStairs(527, blockVerreColored, 14)).setUnlocalizedName("stairsVerreRed");
    public static final Block stairsVerreBlack = (new BlockStairs(528, blockVerreColored, 15)).setUnlocalizedName("stairsVerreBlack");
    
    public static final Block stairsLaineWhite = (new BlockStairs(529, cloth, 0)).setUnlocalizedName("stairsLaineWhite");
    public static final Block stairsLaineOrange = (new BlockStairs(530, cloth, 1)).setUnlocalizedName("stairsLaineOrange");
    public static final Block stairsLaineMagenta = (new BlockStairs(531, cloth, 2)).setUnlocalizedName("stairsLaineMagenta");
    public static final Block stairsLaineSkyBlue = (new BlockStairs(532, cloth, 3)).setUnlocalizedName("stairsLaineSkyBlue");
    public static final Block stairsLaineYellow = (new BlockStairs(533, cloth, 4)).setUnlocalizedName("stairsLaineYellow");
    public static final Block stairsLaineGreen = (new BlockStairs(534, cloth, 5)).setUnlocalizedName("stairsLaineGreen");
    public static final Block stairsLainePink = (new BlockStairs(535, cloth, 6)).setUnlocalizedName("stairsLainePink");
    public static final Block stairsLaineDarkGrey = (new BlockStairs(536, cloth, 7)).setUnlocalizedName("stairsLaineDarkGrey");
    public static final Block stairsLaineLightGrey = (new BlockStairs(537, cloth, 8)).setUnlocalizedName("stairsLaineLightGrey");
    public static final Block stairsLaineCyan = (new BlockStairs(538, cloth, 9)).setUnlocalizedName("stairsLaineCyan");
    public static final Block stairsLainePurple = (new BlockStairs(539, cloth, 10)).setUnlocalizedName("stairsLainePurple");
    public static final Block stairsLaineDarkBlue = (new BlockStairs(540, cloth, 11)).setUnlocalizedName("stairsLaineDarkBlue");
    public static final Block stairsLaineBrown = (new BlockStairs(541, cloth, 12)).setUnlocalizedName("stairsLaineBrown");
    public static final Block stairsLaineDarkGreen = (new BlockStairs(542, cloth, 13)).setUnlocalizedName("stairsLaineDarkGreen");
    public static final Block stairsLaineRed = (new BlockStairs(543, cloth, 14)).setUnlocalizedName("stairsLaineRed");
    public static final Block stairsLaineBlack = (new BlockStairs(544, cloth, 15)).setUnlocalizedName("stairsLaineBlack");
    
    /*TODO: Craft a faire.*/    public static final Block lanterne1 = (new Block(545, Material.glass)).setHardness(0.3F).setStepSound(soundGlassFootstep).setLightValue(1.0F).setUnlocalizedName("lanterne1").setCreativeTab(CreativeTabs.tabDecorations); 
    /*TODO: Craft a faire.*/    public static final Block lanterne2 = (new Block(546, Material.glass)).setHardness(0.3F).setStepSound(soundGlassFootstep).setLightValue(1.0F).setUnlocalizedName("lanterne2").setCreativeTab(CreativeTabs.tabDecorations); 
    /*TODO: Craft a faire.*/    public static final Block lanterne3 = (new Block(547, Material.wood)).setHardness(0.6F).setStepSound(soundWoodFootstep).setLightValue(1.0F).setUnlocalizedName("lanterne3").setCreativeTab(CreativeTabs.tabDecorations); 
    /*TODO: Craft a faire.*/    public static final Block lanterne4 = (new Block(548, Material.wood)).setHardness(0.6F).setStepSound(soundWoodFootstep).setLightValue(1.0F).setUnlocalizedName("lanterne4").setCreativeTab(CreativeTabs.tabDecorations); 
    /*TODO: Craft a faire.*/    public static final Block lanterne5 = (new Block(549, Material.rock)).setHardness(0.9F).setStepSound(soundStoneFootstep).setLightValue(1.0F).setUnlocalizedName("lanterne5").setCreativeTab(CreativeTabs.tabDecorations); 
    /*TODO: Craft a faire.*/    public static final Block lanterne6 = (new Block(550, Material.rock)).setHardness(0.9F).setStepSound(soundStoneFootstep).setLightValue(1.0F).setUnlocalizedName("lanterne6").setCreativeTab(CreativeTabs.tabDecorations); 
    /*TODO: Craft a faire.*/    public static final Block lanterne7 = (new Block(551, Material.iron)).setHardness(1.2F).setStepSound(soundMetalFootstep).setLightValue(1.0F).setUnlocalizedName("lanterne7").setCreativeTab(CreativeTabs.tabDecorations); 
    /*TODO: Craft a faire.*/    public static final Block lanterne8 = (new Block(552, Material.iron)).setHardness(1.2F).setStepSound(soundMetalFootstep).setLightValue(1.0F).setUnlocalizedName("lanterne8").setCreativeTab(CreativeTabs.tabDecorations); 
    
    public static final Block stairsStone = (new BlockStairs(553, stone, 0)).setUnlocalizedName("stairsStone");
    public static final Block stairsDirt = (new BlockStairs(554, dirt, 0)).setUnlocalizedName("stairsDirt"); 
    public static final Block stairsBedrock = (new BlockStairs(555, bedrock, 0)).setUnlocalizedName("stairsBedrock"); 
    public static final Block stairsWood = (new BlockStairs(556, wood, 0)).setUnlocalizedName("stairsWood"); 
    public static final Block stairsBlockGold = (new BlockStairs(557, blockGold, 0)).setUnlocalizedName("stairsBlockGold"); 
    public static final Block stairsBlockIron = (new BlockStairs(558, blockIron, 0)).setUnlocalizedName("stairsBlockIron"); 
    public static final Block stairsCobblestoneMossy = (new BlockStairs(559, cobblestoneMossy, 0)).setUnlocalizedName("stairsCobblestoneMossy"); 
    public static final Block stairsObsidian = (new BlockStairs(560, obsidian, 0)).setUnlocalizedName("stairsObsidian"); 
    public static final Block stairsBlockDiamond = (new BlockStairs(561, blockDiamond, 0)).setUnlocalizedName("stairsBlockDiamond"); 
    public static final Block stairsBlockSnow = (new BlockStairs(562, blockSnow, 0)).setUnlocalizedName("stairsBlockSnow"); 
    public static final Block stairsBlockClay = (new BlockStairs(563, blockClay, 0)).setUnlocalizedName("stairsBlockClay"); 
    public static final Block stairsSlowSand = (new BlockStairs(564, slowSand, 0)).setUnlocalizedName("stairsSlowSand"); 
    public static final Block stairsBlockEmerald = (new BlockStairs(565, blockEmerald, 0)).setUnlocalizedName("stairsBlockEmerald"); 
    public static final Block stairsBlockCuivre = (new BlockStairs(566, blockCuivre, 0)).setUnlocalizedName("stairsBlockCuivre"); 
    public static final Block stairsBlockCitrine = (new BlockStairs(567, blockCitrine, 0)).setUnlocalizedName("stairsBlockCitrine"); 
    public static final Block stairsBlockEmeraude = (new BlockStairs(568, blockEmeraude, 0)).setUnlocalizedName("stairsBlockEmeraude");
    public static final Block stairsBlockSaphir = (new BlockStairs(569, blockSaphir, 0)).setUnlocalizedName("stairsBlockSaphir");
    public static final Block stairsBlockRubis = (new BlockStairs(570, blockRubis, 0)).setUnlocalizedName("stairsBlockRubis");
    
    public static final Block caisseBois = (new BlockCaisseBois(571)).setHardness(0.7F).setStepSound(soundWoodFootstep).setUnlocalizedName("caisseBois"); 
    public static final Block stoneBrick2 = (new BlockStoneBrick2(572)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("stoneBrick2");
    public static final Block stoneBrick3 = (new BlockStoneBrick3(573)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundStoneFootstep).setUnlocalizedName("stoneBrick3");
    public static final Block bibliotheques1 = (new BlockBookshelf(574)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_1");
    public static final Block bibliotheques2 = (new BlockBookshelf(575)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_2");
    public static final Block bibliotheques3 = (new BlockBookshelf(576)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_3");
    public static final Block bibliotheques4 = (new BlockBookshelf(577)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_4");
    public static final Block bibliotheques5 = (new BlockBookshelf(578)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_5");
    public static final Block bibliotheques6 = (new BlockBookshelf(579)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_6");
    public static final Block bibliotheques7 = (new BlockBookshelf(580)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_7");
    public static final Block bibliotheques8 = (new BlockBookshelf(581)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_8");
    public static final Block bibliotheques9 = (new BlockBookshelf(582)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_9");
    public static final Block bibliotheques10 = (new BlockBookshelf(583)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_10");
    public static final Block bibliotheques11 = (new BlockBookshelf(584)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_11");
    public static final Block bibliotheques12 = (new BlockBookshelf(585)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_12");
    public static final Block bibliotheques13 = (new BlockBookshelf(586)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_13");
    public static final Block bibliotheques14 = (new BlockBookshelf(587)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_14");
    public static final Block bibliotheques15 = (new BlockBookshelf(588)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_15");
    public static final Block bibliotheques16 = (new BlockBookshelf2(589)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_16");
    public static final Block bibliotheques17 = (new BlockBookshelf2(590)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_17");
    public static final Block bibliotheques18 = (new BlockBookshelf2(591)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_18");
    public static final Block bibliotheques19 = (new BlockBookshelf2(592)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_19");
    public static final Block bibliotheques20 = (new BlockBookshelf2(593)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_20");
    public static final Block bibliotheques21 = (new BlockBookshelf2(594)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_21");
    public static final Block bibliotheques22 = (new BlockBookshelf2(595)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_22");
    public static final Block bibliotheques23 = (new BlockBookshelf2(596)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_23");
    public static final Block bibliotheques24 = (new BlockBookshelf2(597)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_24");
    public static final Block bibliotheques25 = (new BlockBookshelf2(598)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_25");
    public static final Block bibliotheques26 = (new BlockBookshelf2(599)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_26");
    public static final Block bibliotheques27 = (new BlockBookshelf2(600)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_27");
    public static final Block bibliotheques28 = (new BlockBookshelf2(601)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_28");
    public static final Block bibliotheques29 = (new BlockBookshelf2(602)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_29");
    public static final Block bibliotheques30 = (new BlockBookshelf2(603)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_30");
    public static final Block bibliotheques31 = (new BlockBookshelf3(604)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_31");
    public static final Block bibliotheques32 = (new BlockBookshelf3(605)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_32");
    public static final Block bibliotheques33 = (new BlockBookshelf3(606)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_33");
    public static final Block bibliotheques34 = (new BlockBookshelf3(607)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_34");
    public static final Block bibliotheques35 = (new BlockBookshelf3(608)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_35");
    public static final Block bibliotheques36 = (new BlockBookshelf3(609)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_36");
    public static final Block bibliotheques37 = (new BlockBookshelf3(610)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_37");
    public static final Block bibliotheques38 = (new BlockBookshelf3(611)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_38");
    public static final Block bibliotheques39 = (new BlockBookshelf3(612)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_39");
    public static final Block bibliotheques40 = (new BlockBookshelf3(613)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_40");
    public static final Block bibliotheques41 = (new BlockBookshelf3(614)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_41");
    public static final Block bibliotheques42 = (new BlockBookshelf3(615)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_42");
    public static final Block bibliotheques43 = (new BlockBookshelf3(616)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_43");
    public static final Block bibliotheques44 = (new BlockBookshelf3(617)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_44");
    public static final Block bibliotheques45 = (new BlockBookshelf3(618)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_45");
    public static final Block bibliotheques46 = (new BlockBookshelf4(619)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_46");
    public static final Block bibliotheques47 = (new BlockBookshelf4(620)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_47");
    public static final Block bibliotheques48 = (new BlockBookshelf4(621)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_48");
    public static final Block bibliotheques49 = (new BlockBookshelf4(622)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_49");
    public static final Block bibliotheques50 = (new BlockBookshelf4(623)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_50");
    public static final Block bibliotheques51 = (new BlockBookshelf4(624)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_51");
    public static final Block bibliotheques52 = (new BlockBookshelf4(625)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_52");
    public static final Block bibliotheques53 = (new BlockBookshelf4(626)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_53");
    public static final Block bibliotheques54 = (new BlockBookshelf4(627)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_54");
    public static final Block bibliotheques55 = (new BlockBookshelf4(628)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_55");
    public static final Block bibliotheques56 = (new BlockBookshelf4(629)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_56");
    public static final Block bibliotheques57 = (new BlockBookshelf4(630)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_57");
    public static final Block bibliotheques58 = (new BlockBookshelf4(631)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_58");
    public static final Block bibliotheques59 = (new BlockBookshelf4(632)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_59");
    public static final Block bibliotheques60 = (new BlockBookshelf4(633)).setHardness(1.5F).setStepSound(soundWoodFootstep).setUnlocalizedName("bibliotheques_60");
    
    public static final Block trappeAcier = (new BlockTrapDoor(634, Material.iron)).setHardness(10.0F).setStepSound(soundMetalFootstep).setUnlocalizedName("trappeAcier").disableStats();
    
    public static final Block blockParticules1 = (new BlockParticules1(700)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules2 = (new BlockParticules2(701)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules3 = (new BlockParticules3(702)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules4 = (new BlockParticules4(703)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules5 = (new BlockParticules5(704)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules6 = (new BlockParticules6(705)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules7 = (new BlockParticules7(706)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules8 = (new BlockParticules8(707)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules9 = (new BlockParticules9(708)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules10 = (new BlockParticules10(709)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules11 = (new BlockParticules11(710)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules12 = (new BlockParticules12(711)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules13 = (new BlockParticules13(712)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules14 = (new BlockParticules14(713)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules15 = (new BlockParticules15(714)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules16 = (new BlockParticules16(715)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules17 = (new BlockParticules17(716)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules18 = (new BlockParticules18(717)).setUnlocalizedName("blockInvisible");
    public static final Block blockParticules19 = (new BlockParticules19(718)).setUnlocalizedName("blockInvisible");
    
    public static final Block chair = (new BlockChair(719).setUnlocalizedName("chaise"));
    public static final Block bank = (new BlockBank(720).setUnlocalizedName("bank"));
    public static final Block table = (new BlockTable(721).setUnlocalizedName("table"));
    
    public static final Block wood1 = (new Block(800, Material.wood)).setHardness(2.0F).setResistance(5.0F).setStepSound(soundWoodFootstep).setUnlocalizedName("wood_spruce");
    public static final Block wood2 = (new Block(801, Material.wood)).setHardness(2.0F).setResistance(5.0F).setStepSound(soundWoodFootstep).setUnlocalizedName("wood_birch");
    public static final Block wood3 = (new Block(802, Material.wood)).setHardness(2.0F).setResistance(5.0F).setStepSound(soundWoodFootstep).setUnlocalizedName("wood_jungle");
    ...
    static
    {
        Item.itemsList[cloth.blockID] = (new ItemCloth(cloth.blockID - 8192)).setUnlocalizedName("cloth");
        Item.itemsList[wood.blockID] = (new ItemMultiTextureTile(wood.blockID - 8192, wood, BlockLog.woodType)).setUnlocalizedName("log");
        Item.itemsList[planks.blockID] = (new ItemMultiTextureTile(planks.blockID - 8192, planks, BlockWood.woodType)).setUnlocalizedName("wood");
        Item.itemsList[silverfish.blockID] = (new ItemMultiTextureTile(silverfish.blockID - 8192, silverfish, BlockSilverfish.silverfishStoneTypes)).setUnlocalizedName("monsterStoneEgg");
        Item.itemsList[stoneBrick.blockID] = (new ItemMultiTextureTile(stoneBrick.blockID - 8192, stoneBrick, BlockStoneBrick.STONE_BRICK_TYPES)).setUnlocalizedName("stonebricksmooth");
        Item.itemsList[sandStone.blockID] = (new ItemMultiTextureTile(sandStone.blockID - 8192, sandStone, BlockSandStone.SAND_STONE_TYPES)).setUnlocalizedName("sandStone");
        Item.itemsList[blockNetherQuartz.blockID] = (new ItemMultiTextureTile(blockNetherQuartz.blockID - 8192, blockNetherQuartz, BlockQuartz.quartzBlockTypes)).setUnlocalizedName("quartzBlock");
        Item.itemsList[stoneSingleSlab.blockID] = (new ItemSlab(stoneSingleSlab.blockID - 8192, stoneSingleSlab, stoneDoubleSlab, false)).setUnlocalizedName("stoneSlab");
        Item.itemsList[stoneDoubleSlab.blockID] = (new ItemSlab(stoneDoubleSlab.blockID - 8192, stoneSingleSlab, stoneDoubleSlab, true)).setUnlocalizedName("stoneSlab");
        Item.itemsList[woodSingleSlab.blockID] = (new ItemSlab(woodSingleSlab.blockID - 8192, woodSingleSlab, woodDoubleSlab, false)).setUnlocalizedName("woodSlab");
        Item.itemsList[woodDoubleSlab.blockID] = (new ItemSlab(woodDoubleSlab.blockID - 8192, woodSingleSlab, woodDoubleSlab, true)).setUnlocalizedName("woodSlab");
        Item.itemsList[sapling.blockID] = (new ItemMultiTextureTile(sapling.blockID - 8192, sapling, BlockSapling.WOOD_TYPES)).setUnlocalizedName("sapling");
        Item.itemsList[leaves.blockID] = (new ItemLeaves(leaves.blockID - 8192)).setUnlocalizedName("leaves");
        Item.itemsList[vine.blockID] = new ItemColored(vine.blockID - 8192, false);
        Item.itemsList[tallGrass.blockID] = (new ItemColored(tallGrass.blockID - 8192, true)).setBlockNames(new String[] {"shrub", "grass", "fern"});
        Item.itemsList[snow.blockID] = new ItemSnow(snow.blockID - 8192, snow);
        Item.itemsList[waterlily.blockID] = new ItemLilyPad(waterlily.blockID - 8192);
        Item.itemsList[pistonBase.blockID] = new ItemPiston(pistonBase.blockID - 8192);
        Item.itemsList[pistonStickyBase.blockID] = new ItemPiston(pistonStickyBase.blockID - 8192);
        Item.itemsList[cobblestoneWall.blockID] = (new ItemMultiTextureTile(cobblestoneWall.blockID - 8192, cobblestoneWall, BlockWall.types)).setUnlocalizedName("cobbleWall");
        Item.itemsList[anvil.blockID] = (new ItemAnvilBlock(anvil)).setUnlocalizedName("anvil");
        
        /**-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
        Item.itemsList[blockVerreColored.blockID] = (new ItemCloth(blockVerreColored.blockID - 8192)).setUnlocalizedName("blockVerreColored");
        Item.itemsList[tapisLaine.blockID] = (new ItemCloth(tapisLaine.blockID - 8192)).setUnlocalizedName("tapisLaine");
        Item.itemsList[tapisVerre.blockID] = (new ItemCloth(tapisVerre.blockID - 8192)).setUnlocalizedName("tapisVerre");
        Item.itemsList[caisseBois.blockID] = (new ItemCloth(caisseBois.blockID - 8192)).setUnlocalizedName("caisseBois");
        Item.itemsList[stoneBrick2.blockID] = (new ItemCloth(stoneBrick2.blockID - 8192)).setUnlocalizedName("stoneBrick2");
        Item.itemsList[stoneBrick3.blockID] = (new ItemCloth(stoneBrick3.blockID - 8192)).setUnlocalizedName("stoneBrick3");
        Item.itemsList[chair.blockID] = (new ItemMultiTextureTile(chair.blockID - 8192, chair, BlockFurnitureAbstract.woodType)).setUnlocalizedName("chair");
        Item.itemsList[bank.blockID] = (new ItemMultiTextureTile(bank.blockID - 8192, bank, BlockFurnitureAbstract.woodType)).setUnlocalizedName("bank");
        Item.itemsList[table.blockID] = (new ItemMultiTextureTile(table.blockID - 8192, table, BlockFurnitureAbstract.woodType)).setUnlocalizedName("table");
                /**-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
        ...
        for (int var0 = 0; var0 < 8192; ++var0)
        {
            if (blocksList[var0] != null)
            {
                ...
                {
                    Item.itemsList[var0] = new ItemBlock(var0 - 8192);
