...
import net.minecraft.src.RenderChair;
import net.minecraft.src.RenderBank;
import net.minecraft.src.RenderTable;
...
public class RenderBlocks
{
    ...
    public void renderBlockAsItem(Block par1Block, int par2, float par3)
    {
        ...
        if (var6 != 0 && var6 != 31 && var6 != 39 && var6 != 16 && var6 != 26)
        {
            ...
            if (var6 == 70)
            {
                chair.render(var4, par1Block, par2);
            }
            else if (var6 == 71)
            {
                table.render(var4, par1Block, par2);
            }
            else if (var6 == 72)
            {
                bank.render(var4, par1Block, par2);
            }
